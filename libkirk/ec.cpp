...
int point_is_on_curve(u8 *p)
{
  ...
  hex_dump((char *) "S", s, 20);
  hex_dump((char *) "T", t,20);
  return elt_is_zero(s);
}

void dump_ecc(void) {
  hex_dump((char *) "P", ec_p, 20);
  hex_dump((char *) "a", ec_a, 20);
  hex_dump((char *) "b", ec_b, 20);
  hex_dump((char *) "N", ec_N, 21);
  hex_dump((char *) "Gx", ec_G.x, 20);
  hex_dump((char *) "Gy", ec_G.y, 20);
}
